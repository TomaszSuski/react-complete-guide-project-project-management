...
export default function NoPojectSelected({ npOpenHandler }: NoProjectSelectedProps) {
  return (
    <div className="flex flex-col items-center justify-center w-2/3">
      ...
      <p className="mt-8 ">
        <AddNewProjectButton onClick={npOpenHandler}>Create new project</AddNewProjectButton>
      </p>
    </div>
  );
}
